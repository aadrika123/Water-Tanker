...
Route::group(['middleware' => ['checkToken']], function () {
    ...
    Route::group(['middleware' => ["auth_maker"]], function () {
        Route::controller(WaterTankerController::class)->group(function () {
            ...
            Route::post('water-tanker/search-booking', 'searchApp');                                                               // This is working but not using for now ; dont remove       
            ...
            Route::post('water-tanker/citizenEditFreeBooking', 'citizenEditFreeBooking');
            ...
            Route::post('water-tanker/verifier-search-booking-new', 'searchFreeTankerAppNew');                                      // Rcurrently using this api for search
