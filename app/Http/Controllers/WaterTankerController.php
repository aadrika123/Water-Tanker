...
class WaterTankerController extends Controller
{
    ...
    //             $response = $tran->DailyCollection($request->fromDate, $request->toDate, $request->paymentMode, $request->wardNo, $request->applicationMode);
    //         $perPage = $request->perPage ? $request->perPage : 10;
    //         $paginator = $response->paginate($perPage);
    //         $list = [
    //             "current_page" => $paginator->currentPage(),
    //             "last_page" => $paginator->lastPage(),
    //             "data" => $paginator->items(),
    ...
    //         return response()->json(['status' => True, 'data' => $list, 'msg' => ''], 200);
    //     } else {
    //         return response()->json(['status' => False, 'data' => $list, 'msg' => 'Undefined parameter supply'], 200);
    //     }
    // }
