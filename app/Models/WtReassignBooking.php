...
class WtReassignBooking extends Model
{
    ...
    public function listReassignBooking(){
        return DB::table('wt_reassign_bookings as wrb')
                ...
                ->select('wrb.re_assign_date','wb.applicant_name','wb.booking_date','wb.delivery_date','wb.address','wb.id','wb.mobile as applicant_mobile','wd.driver_name','wd.driver_mobile','wr.vehicle_name','wr.vehicle_no','wc.capacity','hc.name as hydration_center_name')
                ->get();
    }
}
